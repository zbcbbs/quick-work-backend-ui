  ...
  <el-tabs v-model="activeName" style="padding-left: 5px;">
    ...
    <el-tab-pane label="使用说明" name="third">
      <div>
        ...
        <pre class="my-code">
测试所用参数都是沙箱环境，仅供测试使用，申请地址：<a style="color: #00a0e9" href="https://open.alipay.com/platform/home.htm" target="_blank">支付宝开发平台</a>
若雪付款测试，请使用
账号：xxxx@xx.com
密码与支付密码：123456</pre>
        <blockquote class="my-blockquote"> 设备区分</blockquote>
        <pre class="my-code">
// 支付提供两个接口，
// PC端与手机端，并且在前端使用代码识别
