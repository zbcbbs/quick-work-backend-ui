<template>
  <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px;" size="small" label-width="100px">
    <el-form-item label="APPID" prop="appId">
      ...
      <span style="color: #C0C0C0;margin-left: 10px;">APPID,收款账号即为APPID对应支付宝账号</span>
    </el-form-item>
    ...
    <el-form-item label="商户私钥" prop="privateKey">
      ...
      <span style="color: #C0C0C0;margin-left: 10px;">商户私钥，PKCS8格式RSA2私钥</span>
    </el-form-item>
    ...
    <el-form-item label="">
      <el-button :loading="loading" size="medium" type="primary" @click="doSubmit">配置</el-button>
    </el-form-item>
  </el-form>
</template>
