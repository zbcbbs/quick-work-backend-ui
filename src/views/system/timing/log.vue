<template>
  <el-dialog :visible.sync="dialog" append-to-body title="执行日志" width="88%">
    ...
    <el-table v-loading="loading" :data="data" style="width: 100%;margin-top: -10px;">
      ...
      <el-table-column prop="exception" label="异常详情" width="110px">
        <template slot-scope="scope">
          <el-button v-show="scope.row.exception" size="mini" type="text" @click="info(scope.row.exception)">查看详情</el-button>
        </template>
      </el-table-column>
