  ...
  <div class="app-container">
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <el-input v-model="query.filter" clearable size="small" placeholder="用户名搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <rrOperation />
      </div>
      <crudOperation>
        <el-button
          slot="left"
          v-permission="['monitor:user:kick']"
          class="filter-item"
          type="danger"
          icon="el-icon-delete"
          size="mini"
        ...
        <template slot-scope="scope">
          ...
          >
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button :loading="delLoading" type="primary" size="mini" @click="delMethod(scope.row.token, scope.$index)">确定</el-button>
            </div>
