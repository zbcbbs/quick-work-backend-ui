<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column v-if="checkPer(['ROLE_ADMIN','deployHistory:del'])" label="操作" width="100px" align="center">
        <template slot-scope="scope">
          <el-popover
            :ref="scope.row.id"
            v-permission="['ROLE_ADMIN','deployHistory:del']"
            placement="top"
            width="180"
          >
            <p>确定删除本条数据吗？</p>
...
export default {
  ...
  data() {
    return {
      delLoading: false,
      permission: {
        del: ['ROLE_ADMIN', 'deployHistory:del']
      }
    }
  },
  created() {
