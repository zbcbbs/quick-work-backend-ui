  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.name" clearable placeholder="请输入数据库名称" style="width: 200px" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row stripe style="width: 100%" @selection-change="handleCurrentChange">
      ...
      <el-table-column prop="username" width="200px" label="账号" />
      <el-table-column prop="createTime" width="200px" label="创建日期" />
      <el-table-column v-if="checkPer(['mnt:db:edit','mnt:db:del'])" label="操作" width="150px" align="center">
